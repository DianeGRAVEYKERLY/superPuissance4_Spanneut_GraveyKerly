        ...
        if (plateau.grilleRemplie()== false) { // si la grille renvoie false alors elle est vide
            ...
            switch (rep_1) {
                ...
                case 1: //cas où le joueur veut jouer un jeton 
                    ...
                    int i = 0;
                    while (boucle && i < 7){ 
                    //boucle while au lieu de for pour pouvoir sortir de la boucle une fois la ligne définie ça évite d'utiliser un break
                        
                        if(!plateau.presenceJeton(i, col)){ 
                        //verifie la présence d'un jeton dans chaque ligne de la colonne choisie pour definir ses coord.
                            nbr_ligne = i; 
                ...
                case 3: //cas où la réponse est utiliser un desintegrateur
